...
# ==========================================
print("\nMemuat model inceptionv3_best.keras...")
model = tf.keras.models.load_model('inceptionv3_best.keras')
...
print("\nHasil Evaluasi Keras (InceptionV3):")
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Oranges', # Menggunakan warna oranye untuk membedakan hasil
            xticklabels=classes, yticklabels=classes,
            annot_kws={"size": 14})
plt.title('Confusion Matrix - Uji Coba InceptionV3 - B', fontsize=16)
plt.ylabel('Label Asli (True Label)', fontsize=12)
plt.xlabel('Prediksi Model (Predicted Label)', fontsize=12)
plt.tight_layout()

save_path = 'confusion_matrix_inceptionv3_B.png'
