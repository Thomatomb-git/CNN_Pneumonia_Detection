...
# ==========================================
print("\nMemuat model resnet50_best.keras...")
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Purples', # Menggunakan warna ungu untuk membedakan dengan model lain
            xticklabels=classes, yticklabels=classes,
            annot_kws={"size": 14})
plt.title('Confusion Matrix - Uji Coba ResNet50 - B', fontsize=16)
plt.ylabel('Label Asli (True Label)', fontsize=12)
plt.xlabel('Prediksi Model (Predicted Label)', fontsize=12)
plt.tight_layout()

save_path = 'confusion_matrix_resnet50_B.png'
