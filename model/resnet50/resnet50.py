...
# Path ke dataset (berada di luar folder resnet50)
...
def build_model():
    ...
    # Normalisasi khusus ResNet50 (BGR conversion + mean subtraction)
...
# ResNet50 menggunakan banyak layer BatchNormalization, pastikan tetap beku!
...
print("\nPelatihan selesai! Bobot terbaik telah disimpan di 'resnet50_best.keras'.")