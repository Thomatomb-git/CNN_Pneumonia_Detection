...
MODEL_PATH = os.path.join(os.path.dirname(__file__), '..', 'models', 'resnet50_best.keras')
...
plt.tight_layout()
out_path = os.path.join(os.path.dirname(__file__), '..', 'results', 'resnet50_confusion_matrix.png')
